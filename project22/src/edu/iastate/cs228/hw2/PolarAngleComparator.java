...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	{
		// TODO
		int Distance = compareDistance(p1,p2);
		int PolarAngle = comparePolarAngle(p1,p2);
		
		return PolarAngle == 0? Distance: PolarAngle;
		
//		boolean a = (p1.equals(this.referencePoint)==true);
//		boolean b = ((p1.equals(this.referencePoint))==false)&&((p2.equals(this.referencePoint))==false)&&(PolarAngle==-1);
//		boolean c = ((p1.equals(this.referencePoint))==false)&&((p2.equals(this.referencePoint))==false)&&(PolarAngle==0)&&(Distance ==-1);
...
//    	if (CP == 0)
//    		return 0;
//    	else if (p1.equals(this.referencePoint)||CP>0)
//    		return -1;
//    	else 
//    		return 1;
    ...
    public int compareDistance(Point p1, Point p2)
    {
    	...
    	int p1R = dotProduct(p1, p1);
    	int p2R = dotProduct(p2, p2);
    ...
    private int crossProduct(Point p1, Point p2)
    {
    	...
    	int CP = (p1.getX() - this.referencePoint.getX())*(p2.getY() - this.referencePoint.getY())-(p1.getY() - this.referencePoint.getY())*(p2.getX() - this.referencePoint.getX());
    	return CP; 
    }
    ...
    private int dotProduct(Point p1, Point p2)
    {
    	...
    	int DP = (p1.getX() - this.referencePoint.getX())*(p2.getX() - this.referencePoint.getX())+(p1.getY() - this.referencePoint.getY())*(p2.getY() - this.referencePoint.getY());
    	return DP; 
